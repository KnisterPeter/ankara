...
export class ForInStatement extends Statement<babylon.ForInStatement> {
  ...
  public toJavaScript(): string {
    return `for (${this.left.toJavaScript()} in ${this.right.toJavaScript()}) ${this.body.toJavaScript()}\n`;
  }
