...
export class VariableDeclaration extends Statement<babylon.VariableDeclaration> {
  ...
  public instrument(path: string): void {
    ...
    if (this.parent instanceof ForInStatement
        || this.parent instanceof ForOfStatement
  ...
  public toJavaScript(): string {
    const isStatement = !(this.parent instanceof ForInStatement || this.parent instanceof ForOfStatement || this.parent instanceof ForStatement);
